...
支持手机竖屏完整体验：界面布局、雨玻璃分辨率、烟花粒子预算都会按移动端自动降级，保持流畅不掉帧。

| 移动端 · 微笑雨滴 | 移动端 · 大笑烟花 |
| :---: | :---: |
| ![移动端微笑](./pics/smile_phone.jpg) | ![移动端大笑](./pics/laugh_phone.jpg) |

> PS：初次使用需等待一小会儿加载表情模型，加载完成后即可实时识别。
